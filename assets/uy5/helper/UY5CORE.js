 ...
 sap.ui.define(["sap/ui/base/ManagedObject", "sap/base/Log", "sap/m/MessageBox", "sap/ui/core/format/DateFormat",
 	...
 	function (ManagedObect, Log, MessageBox, DateFormat, DYNMODEL, JSONModelExt, cryptojs) {
 		...
 		return ManagedObect.extend('it.fiorital.fioritalui5lib.framework.uy5.helper.UY5CORE', {
 			...
 			constructor: function (connectionName, modelRef, xmlModelPath, disableRegexpEscapigOnJSONResults, sendXsession, sessionUser ) {
			...
			syncModel: function(modelName){
				return this.SyncModels.find(function(smd){
				  return (smd.NAME === modelName);
				})
			},
 			...
 			_CallSuccess: function (dt) {
 				...
 				if (inException === true) {
 					 ...
 					 */
 					this.successFct(this.thisRef.Result, this.thisRef.ObjToPass, this.thisRef.exceptionText);
