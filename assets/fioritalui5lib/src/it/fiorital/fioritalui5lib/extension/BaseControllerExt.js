...
sap.ui.define([
	...
	"sap/base/Log"
], function(Controller, History, NavigationHandler, Log) {
	"use strict";

	return Controller.extend("it.fiorital.fioritalui5lib.extension.BaseControllerExt", {

		homeViewName: "homeViewName", //<-- DEFAULT Home route
		...
		onInit: function() {
			...
			Log.info("it.fiorital.fioritalui5lib: onInit() ...");			
		},
		
		onNavBack: function (oEvent) {
			
			Log.info("it.fiorital.fioritalui5lib: Routing back ...");
			...
			if (sPreviousHash !== undefined) {
				...
				this.getRouter().navTo(this.homeViewName, {}, true /*no history*/);
			}
		},

		setHomeView: function(homeViewPatternName) {
			this.homeViewName = homeViewPatternName;
		},
		
		isExtendedController: function() {
			return true;
		}
