sap.ui.define([
	...
	function (jQuery, XMLComposite, MessageToast, MessageBox, Filter, FilterOperator, Utilities) {
		...
		var PricingManager = XMLComposite.extend("it.fiorital.fioritalui5lib.controls.PricingManagerDirect", {
			metadata: {
				properties: {
					title: {
						type: "string",
			...
			init: function () {
				...
				this._pricingManagerList.setBindingContext(null);
			...
			openDirectRebind: function (evt, directPath, explicitModelName) {
				...
				this._pricingManagerList.setBindingContext(new sap.ui.model.Context(this.getModel(), directPath));
